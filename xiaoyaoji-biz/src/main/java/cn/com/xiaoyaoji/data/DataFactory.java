...
public class DataFactory implements Data {
    ...
    */
    ...
    @Override
    public int updateProjectUserEditable(final String projectId, final String userId,
    ...
    @Override
    public int updateCommonlyUsedProject(final String projectId, final String userId,
                                         final String isCommonlyUsed) {
        return process(new Handler<Integer>() {
            @Override
            public Integer handle(Connection connection, QueryRunner qr) throws SQLException {
